...
export function FileUpload({ onFileLoaded, isLoading, currentFileName, onReset }: FileUploadProps) {
  ...
  return (
    <div id="file-upload-section" className="w-full bg-white border border-slate-200 rounded-xl p-5 shadow-xs">
      <div className="flex items-center justify-between gap-3 mb-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-medium transition-colors shrink-0 cursor-pointer"
        >
        ...
        <div className="flex items-center justify-between p-4 bg-emerald-50/60 border border-emerald-200 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-md border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 text-xs font-medium transition-colors cursor-pointer"
            >
              Đổi file
            </button>
            <button
          ...
          <div className="flex flex-col items-center justify-center gap-2.5">
            ...
            <div>
              <p className="text-xs font-medium text-slate-700">
                Kéo thả file Excel (.xlsx, .csv) hoặc <span className="text-emerald-600 underline">chọn file</span>
              </p>
            </div>
          </div>
        </div>
